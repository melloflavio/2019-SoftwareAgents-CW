...
\section{Q-Matrix Update Cycle}
    ...
    Implementation-wise the code, in Python, used for updating the Q-Matrix is shown in \ref{lst:q_update_code}
...
\section{Further Tests}\label{sec:further_tests}
    ...
    \subsection{$\epsilon$ decay}
        Regarding the $\epsilon$ decay, 2 different tests were done: \textbf{a)} Vary the threshold at which the decay changes; \textbf{b)} vary the $\epsilon$-decay rates.
...
\section{Advanced Reinforcement Learning Techniques}
    ...
    \begin{figure}[h]
        \includegraphics[height=5cm]{Images/exp_II/1_winning.png}
    ...
    \begin{figure}[h]
        \includegraphics[height=5cm]{Images/exp_III/1_winning.png}
